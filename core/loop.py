...
def build_system_prompt(config: dict, data_dir: Optional[Path] = None,
    ...
    if not quick_mode:
        ...
        system_prompt += (
            ...
            f"without explicit user permission. Your role is to:\\n"
            ...
            f"NOTE: model.default is a user preference — user CAN change it via config(action=set).\\n"
            f"Do NOT use config(action=set) to change providers, fallbacks, or capabilities unless\\n"
