...
Run: python3 -c "import sys; sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent))"
"""
import sys
from pathlib import Path as _P; sys.path.insert(0, str(_P(__file__).resolve().parent.parent.parent))
