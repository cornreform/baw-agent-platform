...
content = open('/home/radxa/baw/core/messaging/telegram.py', 'r').read()
...
open('/home/radxa/baw/core/messaging/telegram.py', 'w').write(content)

# Verify syntax
import py_compile
try:
    py_compile.compile('/home/radxa/baw/core/messaging/telegram.py', doraise=True)
    print("Syntax OK!")
