...
| **Telegram Bot** | `core/messaging/telegram.py:103-131` | Sunny / 移動 | 24 個 commands 但冇 menu hierarchy、typing 動作唔穩定 |
...
### 5.1 Telegram bot (核心 — Sunny 主力入口)
...
> Sunny 問過「最強 coding model」,我冇用 Sonnet 跑 audit。原因:
